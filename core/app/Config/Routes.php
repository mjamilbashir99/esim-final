...
$routes->get('compatibility/google', 'EsimCompatibility\CompatibilityController::google');
$routes->get('compatibility/samsung', 'EsimCompatibility\CompatibilityController::samsung');
$routes->get('compatibility/huawei', 'EsimCompatibility\CompatibilityController::huawei');
$routes->get('compatibility/laptop', 'EsimCompatibility\CompatibilityController::laptop');
$routes->get('compatibility/oppo', 'EsimCompatibility\CompatibilityController::oppo');
$routes->get('compatibility/other', 'EsimCompatibility\CompatibilityController::other');
